...
All 5 plans shipped. Kadai's MVP is done.
...
| 3 | [Hooks (guardrails)](2026-05-05-kadai-03-hooks.md) | **DONE** | `PreToolUse` blocks off-spine edits; `PostToolUse` captures changelog |
| 4 | [Web viewer (read-only)](2026-05-05-kadai-04-web-viewer.md) | **DONE** | Roadmap + drill-down views at localhost |
| 5 | [Plugin + dogfood](2026-05-05-kadai-05-plugin-and-dogfood.md) | **DONE** (Task 7 deferred) | Bundled skill + slash commands; subagent acceptance test PASS-with-notes |
